...
# def get_prize_doors(total_doors=defaults.DOORS_TOTAL_STANDARD, prize_doors=defaults.DOORS_PRIZE_STANDARD):
#     doors = {}
...
#     return doors
#
# def setup_doors(total_doors=defaults.DOORS_TOTAL_STANDARD, prize_doors=defaults.DOORS_PRIZE_STANDARD):
#     doors = []
...
# def make_guesses(doors, guesses=defaults.DOORS_GUESS_STANDARD):
#     marked_guessed = 0
...
def open_losing_doors(doors, total_doors_to_open=defaults.DOORS_REVEAL_STANDARD):
    open_doors_count = 0
...
# def prepare_doors(total=defaults.DOORS_TOTAL_STANDARD, prizes=defaults.DOORS_PRIZE_STANDARD, guess=defaults.DOORS_GUESS_STANDARD, open=defaults.DOORS_REVEAL_STANDARD):
